//! SPI Commands for the Waveshare 7.5"(H) - Ink Display
...
pub(crate) enum Command {
    ...
    TconResolutionSetting = 0x61,

    /// This command defines MCU host direct access external memory mode.
    // TODO look up this is not in the datasheet but it seems they moved to 0x62
    // SpiFlashControl = 0x65,
    SpiFlashControl = 0x62,
